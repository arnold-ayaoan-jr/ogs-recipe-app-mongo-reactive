...
//            throw new RuntimeException("Recipe not found");
    ...
    public String updateIngredient(@PathVariable String recipeId, @PathVariable String ingredientId, Model model) {
        Mono<IngredientCommand> ingredientCommand = ingredientService.getIngredientCommandByIdAndRecipeId(ingredientId, recipeId);
...
//            throw new RuntimeException("Ingredient not found");
    ...
    public String saveIngredient(@PathVariable String recipeId, @ModelAttribute IngredientCommand ingredientCommand) {
        Mono<IngredientCommand> savedIngredientCommand = ingredientService.saveIngredientCommand(ingredientCommand);

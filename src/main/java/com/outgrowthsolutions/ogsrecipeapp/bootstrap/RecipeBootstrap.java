package com.outgrowthsolutions.ogsrecipeapp.bootstrap;

import com.outgrowthsolutions.ogsrecipeapp.domain.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private void loadCategories() {
        ...
        Category filipino = new Category();
        filipino.setDescription("Filipino");
        categoryRepository.save(filipino);
    ...
    private List<Recipe> getRecipes(){
        ...
        guacRecipe.setCookTime(300);
        guacRecipe.setYield(4);
        ...
        log.debug("RecipeBootstrap::getRecipes - returning "+recipes.size()+" item(s)");
        return recipes;
    }
}
